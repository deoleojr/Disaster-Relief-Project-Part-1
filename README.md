...
#### **Data Visualizations**
1. **Histograms**: Provide insight into pixel value distributions across color channels.
2. **Scatter Plot Matrix**: Highlights strong correlations between the Red, Green, and Blue channels.

---

### **Data Preprocessing and Transformation**
1. **Handling Missing Values**: Rows with NA values were removed.
2. **Converting Class to Binary Outcome**: Simplified the task into a binary classification problem.
3. **Normalization**: Standardized predictors to improve model performance.

---

### **Methodology**
#### **Model Training, Tuning, and Validation**
1. **Software**: Analysis performed in R using:
   - `tidyverse` for data manipulation and visualization.
   - `pROC` for ROC curve analysis.
   - `GGally` for exploratory data analysis.
2. **Validation**: Used 10-fold cross-validation to ensure robust performance evaluation.
